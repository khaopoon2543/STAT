...
<html lang="en">
  ...
  <body>
        ...
        <form action="index2_db.php" method="post">
        <div class="container">
            <div class="row">
                <div class="col-6 py-3">
                    <div class="card">  
                        <input type="radio" class="radio mx-1" name="pattern[]" value='1'></input>  
                        คนงานเลี้ยงเป็ด ซดเหล้ากับเพื่อน ถูกทุบหัวแบะ ดับสยองกลางทุ่งนา
                    </div>
                </div>
                <div class="col-6 py-3">
                    <div class="card">  
                        <input type="radio" class="radio mx-1" name="pattern[]" value='2'></input>  
                        คนงานเลี้ยงเป็ด ดื่มเหล้ากับเพื่อน ถูกทุบหัว เสียชีวิตกลางทุ่งนา 
                    </div>
                </div>
